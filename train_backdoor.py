...
def train_step(
    ...
    for batch_idx, (inputs1, targets1) in enumerate(train_dl1):
        ...
        inputs_bd, targets_bd = create_bd(inputs1[:num_bd], targets1[:num_bd], opt, num_bd)
        ...
        if batch_idx == len(train_dl1) - 2:
            ...
            images = netG.denormalize_pattern(torch.cat((inputs1[:num_bd], inputs_bd), dim=2))
