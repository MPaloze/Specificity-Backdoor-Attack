        ...
        for task in neuron_dict[key]:
            ...
            for i in range(mask_multi_start):
                acc, rimg, rdelta, rmask, optz_label = reverse_engineer(model_type, model, children, images, labels,
                                                                        ...
                                                                        samp_label, Troj_size, re_epochs)
...
def test(model, model_type, test_xs, result, scratch_dirpath, mode='mask'):
    ...
    print(preds)
    score = float(np.sum(tlabel == preds)) / float(yt.shape[0]-20)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_filepath', type=str, help='File path to the pytorch model file to be evaluated.',
                        default='../../checkpoints_backdoor(0.3)/cifar10/all2one/target_0/all2one_cifar10_ckpt.pth.tar')
